...
config :quote_assist, QuoteAssistWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: QuoteAssistWeb.ErrorHTML, json: QuoteAssistWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: QuoteAssist.PubSub,
  live_view: [signing_salt: "MZPwG0cO"]
...
config :quote_assist, QuoteAssist.Mailer, adapter: Swoosh.Adapters.Local
