defmodule QuoteAssistWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: QuoteAssistWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(QuoteAssistWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(QuoteAssistWeb.Gettext, "errors", msg, opts)
    end
  end
